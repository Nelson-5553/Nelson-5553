...
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/components/en/Badge.astro", void 0);
...
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/components/en/ButtomLink.astro", void 0);
...
`;
  return renderTemplate`${maybeRenderHead()}<div data-aos="fade-up"></div> <div id="Inicio" class="flex justify-start items-center space-x-4 text-left"> <img src="/img/NELSON.jpg" alt="Perfil" class="rounded-full h-16 w-16 shadow-lg"> ${renderComponent($$result, "Badge", $$Badge, {}, { "default": ($$result2) => renderTemplate`Available for work` })} </div> <h2 class="text-4xl font-bold -mt-4">Hello, I'm Nelson</h2> <p class="text-xl text-left mt-2 w-full md:w-3/4 lg:w-2/3">
Systems Engineer with <span class="text-blue-500 font-bold">+2 years</span> of experience in the field. With a solid technical background, I specialize in <span class="text-blue-500 font-bold">Web Development</span> and have a quick ability to adapt to new technologies. My proactive approach allows me to efficiently solve digital challenges.
</p> <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 lg:w-1/2 w-auto"> ${renderComponent($$result, "ButtomLink", $$ButtomLink, { "link": "https://www.linkedin.com/in/nelson-jimenez-10429a337/", "text": "Linkedin", "icon": LinkedinImage })} ${renderComponent($$result, "ButtomLink", $$ButtomLink, { "link": "https://github.com/Nelson-5553", "text": "GitHub", "icon": GithubImage })} ${renderComponent($$result, "ButtomLink", $$ButtomLink, { "link": "mailto:andresnelson2004@hotmail.com", "text": "Contactame", "icon": MailImage })} ${renderComponent($$result, "ButtomLink", $$ButtomLink, { "link": "https://frontend-1-4-mgww.onrender.com", "text": "LinkTree", "icon": LinkImage })} ${renderComponent($$result, "ButtomLink", $$ButtomLink, { "link": "/PDF/HV.pdf", "text": "Curriculum", "icon": HvImage })} </div> `;
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/components/en/welcome.astro", void 0);

const $$Projects = createComponent(async ($$result, $$props, $$slots) => {
  const experienceEntries = (await getCollection("projects", ({ id }) => id.startsWith("en/"))).filter(
  ...
  return renderTemplate`${maybeRenderHead()}<div class="mt-36" data-aos="fade-up"> <div id="proyecto" class="flex flex-row justify-center items-center space-x-4"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8"> <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5"></path> </svg> <h2 class="font-bold mt-6">Projects</h2> </div> <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8"> ${renderedExperiences.map((project) => {
...
Initial load slow due to serverless. If unresponsive, reload the page.
</p> </div>`;
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/components/en/projects.astro", void 0);

const $$Experience = createComponent(async ($$result, $$props, $$slots) => {
  const experienceEntries = await getCollection("experience", ({ id }) => id.startsWith("en/"));
  const renderedExperiences = await Promise.all(
    experienceEntries.map(async (entry) => {
      const rendered = await entry.render();
      return {
...
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/components/en/Footer.astro", void 0);

const $$Books = createComponent(async ($$result, $$props, $$slots) => {
  const books = await getCollection("books", ({ id }) => id.startsWith("en/"));
...
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/components/en/Books.astro", void 0);

const $$Certified = createComponent(async ($$result, $$props, $$slots) => {
  const certified = await getCollection("certified", ({ id }) => id.startsWith("en/"));
...
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/components/en/Certified.astro", void 0);
  ...
  const estudios = [
    {
      ...
      "lugar": "Comfenalco Technological Institute, Cartagena De Indias",
      "color": "bg-sky-500"
    },
    {
      "periodo": "2021-02 - 2022-11",
      "nombre": "Software Development Technology",
      "lugar": "Comfenalco Technological Institute, Cartagena De Indias",
      "color": "bg-emerald-500"
    },
    {
      "periodo": "2019-02 - 2020-11",
      "nombre": "Systems Technician",
      "lugar": "Cedesarrollo Institution, Cartagena De Indias",
      "color": "bg-orange-500"
    }
  ];
  return renderTemplate`${maybeRenderHead()}<div data-astro-cid-hbhbrytr> <h2 class="mb-4 text-2xl font-bold text-blue-500 dark:text-blue-500" data-astro-cid-hbhbrytr>
My Studies
</h2> <p class="mb-6 text-base font-normal prose dark:prose-invert" data-astro-cid-hbhbrytr>
Here you can see my studies and academic training.
</p> </div> ${estudios.map((studios) => renderTemplate`<div class="w-full" data-astro-cid-hbhbrytr> <!-- Línea superior --> <div${addAttribute(`h-1 ${studios.color} w-full rounded-t-md`, "class")} data-astro-cid-hbhbrytr></div> <!-- Contenedor principal --> <div class="grid grid-cols-1 sm:grid-cols-[auto,1fr,auto] gap-4 items-center border bg-slate-100/70 dark:bg-neutral-900 w-full p-4 sm:p-6 border-gray-200 dark:border-neutral-700 rounded-b-lg mb-6 shadow-sm" data-astro-cid-hbhbrytr> <!-- Icono --> <div class="flex justify-center sm:justify-start items-center" data-astro-cid-hbhbrytr> <div${addAttribute(`w-12 h-12 ${studios.color} text-white rounded-md flex items-center justify-center`, "class")} data-astro-cid-hbhbrytr> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-astro-cid-hbhbrytr> <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" data-astro-cid-hbhbrytr></path> </svg> </div> </div> <!-- Nombre y lugar --> <div class="text-center sm:text-left" data-astro-cid-hbhbrytr> <h3 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white" data-astro-cid-hbhbrytr>${studios.nombre}</h3> <p class="text-sm text-gray-600 dark:text-gray-400" data-astro-cid-hbhbrytr>${studios.lugar}</p> </div> <!-- Periodo --> <div class="flex justify-center sm:justify-end" data-astro-cid-hbhbrytr> <span class="bg-sky-100 text-sky-800 text-xs font-medium px-2.5 py-0.5 rounded-sm dark:bg-sky-900 dark:text-sky-300" data-astro-cid-hbhbrytr> ${studios.periodo} </span> </div> </div> </div>`)} `;
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/components/en/studios.astro", void 0);

const $$EducationBoard = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="w-full mt-36" data-aos="fade-up" data-astro-cid-zle4l3gn> <div id="estudios" class="flex flex-row justify-center items-center space-x-4" data-astro-cid-zle4l3gn> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8" data-astro-cid-zle4l3gn> <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" data-astro-cid-zle4l3gn></path> </svg> <h2 class="font-bold mt-6" data-astro-cid-zle4l3gn>Education</h2> </div> <div class="w-full bg-gray-200 dark:bg-neutral-950 p-2 rounded-lg mt-4 dark:shadow-md" data-astro-cid-zle4l3gn> <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm font-medium text-center text-blue-500 dark:text-blue-400" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist" data-astro-cid-zle4l3gn> <button id="stats-tab" data-tabs-target="#stats" type="button" role="tab" aria-controls="stats" aria-selected="false" class="w-full text-lg p-1.5 transition-colors duration-200 border-2 border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-neutral-950 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none" data-astro-cid-zle4l3gn>
Studies
</button> <button id="about-tab" data-tabs-target="#about" type="button" role="tab" aria-controls="about" aria-selected="false" class="w-full text-lg p-1.5 transition-colors duration-200 border-2 border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-neutral-950 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none" data-astro-cid-zle4l3gn>
Certificates
</button> <button id="faq-tab" data-tabs-target="#faq" type="button" role="tab" aria-controls="faq" aria-selected="false" class="w-full text-lg p-1.5 transition-colors duration-200 border-2 border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-neutral-950 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none" data-astro-cid-zle4l3gn>
Books
</button> </div> </div> <div id="fullWidthTabContent" data-astro-cid-zle4l3gn> <div class="hidden rounded-b-lg" id="stats" role="tabpanel" aria-labelledby="stats-tab" data-astro-cid-zle4l3gn> ${renderComponent($$result, "Studios", $$Studios, { "data-astro-cid-zle4l3gn": true })} </div> <div class="hidden rounded-b-lg " id="about" role="tabpanel" aria-labelledby="about-tab" data-astro-cid-zle4l3gn> ${renderComponent($$result, "Certified", $$Certified, { "data-astro-cid-zle4l3gn": true })} </div> <div class="hidden rounded-b-lg " id="faq" role="tabpanel" aria-labelledby="faq-tab" data-astro-cid-zle4l3gn> ${renderComponent($$result, "Books", $$Books, { "data-astro-cid-zle4l3gn": true })} </div> </div> </div> `;
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/components/en/EducationBoard.astro", void 0);
...
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/components/en/PercentageHability.astro", void 0);

const $$HabilityBoard = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="w-full mt-36" data-aos="fade-up" data-astro-cid-aiz7u4bm> <div id="habilidades" class="flex flex-row justify-center items-center space-x-4" data-astro-cid-aiz7u4bm> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8" data-astro-cid-aiz7u4bm> <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" data-astro-cid-aiz7u4bm></path> </svg> <h2 class="font-bold mt-6" data-astro-cid-aiz7u4bm>Skills</h2> </div> <div class="w-full bg-gray-200 dark:bg-neutral-950 p-2 rounded-lg mt-4 dark:shadow-md" data-astro-cid-aiz7u4bm> <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4  gap-4 text-sm font-medium text-center text-blue-500 dark:text-blue-400" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist" data-astro-cid-aiz7u4bm> <button id="Backend" data-tabs-target="#backend" type="button" role="tab" aria-controls="stats" aria-selected="false" class="w-full text-lg p-1.5 transition-colors duration-200 border-2 border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-neutral-950 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none" data-astro-cid-aiz7u4bm>
Backend
</button> <button id="Frontend" data-tabs-target="#frontend" type="button" role="tab" aria-controls="about" aria-selected="false" class="w-full text-lg p-1.5  transition-colors duration-200 border-2 border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-neutral-950 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none" data-astro-cid-aiz7u4bm>
Frontend
</button> <button id="Database" data-tabs-target="#database" type="button" role="tab" aria-controls="faq" aria-selected="false" class="w-full text-lg p-1.5  transition-colors duration-200 border-2 border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-neutral-950 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none" data-astro-cid-aiz7u4bm>
Databases
</button> <button id="Tools" data-tabs-target="#tools" type="button" role="tab" aria-controls="faq" aria-selected="false" class="w-full text-lg p-1.5  transition-colors duration-200 border-2 border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-neutral-950 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none" data-astro-cid-aiz7u4bm>
Tools
</button> </div> </div> <div id="fullWidthTabContent" data-astro-cid-aiz7u4bm> <div class="hidden rounded-b-lg" id="backend" role="tabpanel" aria-labelledby="stats-tab" data-astro-cid-aiz7u4bm> <div class="grid md:grid-cols-2 gap-8 bg-white dark:bg-neutral-950/60 rounded-lg p-6 mt-8" data-astro-cid-aiz7u4bm> ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "PHP", "percentage": "90", "image": "php", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "LARAVEL", "percentage": "90", "image": "laravel", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "PYTHON", "percentage": "80", "image": "python", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "NODE", "percentage": "60", "image": "nodejs", "data-astro-cid-aiz7u4bm": true })} </div> </div> <div class="hidden rounded-b-lg " id="frontend" role="tabpanel" aria-labelledby="about-tab" data-astro-cid-aiz7u4bm> <div class="grid md:grid-cols-2 gap-8 bg-white dark:bg-neutral-950/60 rounded-lg p-6 mt-8" data-astro-cid-aiz7u4bm> ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "CSS3", "percentage": "80", "image": "css", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "HTML", "percentage": "90", "image": "html5", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "JAVASCRIPT", "percentage": "70", "image": "javascript", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "ASTRO", "percentage": "95", "image": "astro", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "NEXTJS", "percentage": "70", "image": "nextjs", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "LIVEWIRE", "percentage": "75", "image": "livewire", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "TAILWINDCSS", "percentage": "99", "image": "tailwindcss", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "ALPINE JS", "percentage": "80", "image": "alpine", "data-astro-cid-aiz7u4bm": true })} </div> </div> <div class="hidden rounded-b-lg " id="database" role="tabpanel" aria-labelledby="faq-tab" data-astro-cid-aiz7u4bm> <div class="grid md:grid-cols-2 gap-8 bg-white dark:bg-neutral-950/60 rounded-lg p-6 mt-8" data-astro-cid-aiz7u4bm> ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "MONGODB", "percentage": "60", "image": "mongodb", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "MYSQL", "percentage": "90", "image": "mysql", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "POSTGRESQL", "percentage": "80", "image": "postgresql", "data-astro-cid-aiz7u4bm": true })} </div> </div> <div class="hidden rounded-b-lg " id="tools" role="tabpanel" aria-labelledby="faq-tab" data-astro-cid-aiz7u4bm> <div class="grid md:grid-cols-2 gap-8 bg-white dark:bg-neutral-950/60 rounded-lg p-6 mt-8" data-astro-cid-aiz7u4bm> ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "AWS", "percentage": "60", "image": "aws_light", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "SWAGGER", "percentage": "70", "image": "swagger", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "POSTMAN", "percentage": "80", "image": "postman", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "LINUX", "percentage": "80", "image": "linux", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "DOCKER", "percentage": "85", "image": "docker", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "GIT", "percentage": "95", "image": "git", "data-astro-cid-aiz7u4bm": true })} ${renderComponent($$result, "PercentageHability", $$PercentageHability, { "name": "POWER BI", "percentage": "70", "image": "powerbi", "data-astro-cid-aiz7u4bm": true })} </div> </div> </div> </div> `;
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/components/en/HabilityBoard.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Nelson", "lang": "en", "class": "some-class" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Welcome", $$Welcome, {})} ${renderComponent($$result2, "Projects", $$Projects, {})} ${renderComponent($$result2, "HabilityBoard", $$HabilityBoard, {})} ${renderComponent($$result2, "EducationBoard", $$EducationBoard, {})} ${renderComponent($$result2, "Experience", $$Experience, {})} ${maybeRenderHead()}<br> ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
}, "/home/runner/work/Nelson-5553/Nelson-5553/src/pages/en/index.astro", void 0);

const $$file = "/home/runner/work/Nelson-5553/Nelson-5553/src/pages/en/index.astro";
const $$url = "/en";
